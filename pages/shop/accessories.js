...
const Category = ({ allProducts }) => {
    ...
    const handlePriceFilter = async(e) => {
        ...
        const { data } = await axios(`http://localhost:3005/products/category/accessories?min=${price.min}&max=${price.max}`);
                        ...
                        <div className="col-lg-3 col-xl-3 col-xxl-3 d-none d-lg-block">
                            <div>
                                <div className="shop-cartigory">
                                    ...
                                    <p><Link href="/shop/accessories" className="active" >Accessories</Link></p>
                                </div>
                                <div>
                                    <h3>Pricing</h3>
...
export async function getServerSideProps(context) {
    ...
    const { data } = await axios(`http://localhost:3005/products/category/accessories${queryString}`);
    if (!data.error){
        return {
