...
const Category = ({ allProducts, user }) => {
    ...
    const handlePriceFilter = async(e) => {
        ...
        const data = await CategoryProducts("jewelries", price.min, price.max);
        // console.log(data)
                        ...
                        <div className="col-lg-3 col-xl-3 col-xxl-3 d-none d-lg-block">
                            <div>
                                <div className="shop-cartigory">
                                    ...
                                    <p><Link href="/shop/jewelries" className="active" >Jewelries</Link></p>
...
export async function getServerSideProps(context) {
    ...
    try {
        const data = await CategoryProducts("jewelries", min, max);
